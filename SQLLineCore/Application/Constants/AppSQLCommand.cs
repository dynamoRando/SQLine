...
namespace SQLineCore
{
    ...
    {
        public static class SQLServerCommand
        {
            internal const string GetTables = "SELECT s.name SchemaName, t.name TableName, object_id ObjectId FROM sys.tables t inner join sys.schemas s on t.schema_id = s.schema_id";
